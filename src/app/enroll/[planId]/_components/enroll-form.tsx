...
interface FormData {
  ...
  state: string; zip: string; cardNumber: string; cardExpiry: string;
  cardCvc: string; nameOnCard: string; agreeTerms: boolean;
}
...
export function EnrollForm({ plan }: { plan: Plan }) {
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-card p-6 sm:p-8">
                ...
                <div className="text-center py-6">
                  ...
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 text-left mb-6">
                    ...
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between"><span className="text-slate-500">Plan</span><span className="font-semibold">{plan.name}</span></div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <a href="tel:18005551234"><Button variant="secondary"><Phone className="w-4 h-4 mr-1" /> Talk to an Agent</Button></a>
                  </div>
                </div>
              )}
              ...
              {step < 4 && (
                <div className="flex justify-between mt-8 pt-5 border-t border-slate-100">
                  ...
                  {step < 3 ? (
                    <Button onClick={() => setStep((s) => s + 1)}>Continue <ArrowRight className="w-4 h-4 ml-1" /></Button>
                  ) : (
                    <Button onClick={() => setStep(4)} disabled={!form.agreeTerms}>
          ...
          <div>
            <div className="sticky top-24 space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 text-center">
                ...
                <a href="tel:18005551234" className="text-sm font-bold text-blue-700 hover:text-blue-900">1-800-555-1234</a>
              </div>
            </div>
          </div>
        </div>
